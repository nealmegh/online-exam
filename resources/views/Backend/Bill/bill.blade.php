                                    ...
                                    @foreach($bills as $bill)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{--<i class="fa fa-eye"></i>--}}
                                                {{--</a> ||--}}
                                                <a title="Show Bill" href="{{route('bill.show', $bill->id)}}" class="btn btn-success">
...
{{--                                            <!--@if(Storage::disk('public')->exists('/csv/'.$bill->id.'.pdf'))-->--}}
                                                ...
                                                @if($bill->status == 0)
                                                    ...
                                                    <a title="Collect Bill" class="btn btn-dark" onclick="return confirm('Are you sure?')" href="{{route('bill.collect', $bill->id)}}">
