                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  href="{{route('user.edit', $user->id)}}" class="btn btn-primary" title="Edit Customer" >
                                        <i class="far fa-edit"></i>
                                    </a>


{{--                                    <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{route('user.delete', $user->id)}}" class="btn btn-sm btn-danger">--}}
