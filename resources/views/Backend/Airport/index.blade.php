                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col 12 button-holder" style="display: flex">
                        ...
                        <div class="create-button col-4">
                            <a href="{{route('airport.create')}}" class="create-button-btn btn btn-success mb-6 mr-4 btn-lg"> Create</a>
                        </div>
                    </div>
...
{{--                                    <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{route('airport.delete', $airport->id)}}">--}}
