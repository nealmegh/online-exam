                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h2><small>edit</small> Airports </h2>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        <form class="" novalidate method="post" action="{{route('airport.update', $airport->id )}}">
                            @csrf
                            <div class="form-row mb-4">
                                <label class="control-label" for="name">Name <span class="required">*</span>
                                </label>
                                <input id="name" class="form-control" value="{{$airport->name}}" name="name" placeholder="Name of the Airport" required="required" type="text">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label" for="display_name">Display Name <span class="required">*</span>
                                </label>
                                <input type="text" id="display_name" value="{{$airport->display_name}}" name="display_name" placeholder="Display Name of the Airport" required="required" class="form-control">
                            </div>
