            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                            ...
                            <tr>
                                <td><a href="{{route('driver.show', $user->id)}}">{{$user->name}}</a></td>
                                ...
                                foreach ($user->trips as $trip)
                                    {
                                        if(!empty($trip->invoice) && !empty($trip->invoice->bill))
                                        {
                                       $dues[$trip->invoice->bill->id] = $trip->invoice->bill->total_payable;
                                        }
                                    }

                                @endphp
                                <td>{{array_sum($dues)}}</td>

                                <td>
                                    {{--<a href="{{route('cars.show', $user->id)}}" data-toggle="modal"  class="btn btn-sm btn-success viewFunction">--}}
                                        {{--<i class="fa fa-eye"></i>--}}
                                    {{--</a> ||--}}
                                    <a href=" {{route('driver.edit', $user->id)}}" class="btn btn-primary ">
