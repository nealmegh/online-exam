                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h2><small>details of</small> {{$driver->user->name}}</h2>
                            </div>
                        </div>
                    </div>


                    <ul class="nav nav-pills mb-3 mt-3 justify-content-center" id="simpletab" role="tablist">
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="simpletabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class=" row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">First Name:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5>{{$driver->first_name}}</h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Last Name:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5>{{$driver->last_name}}</h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Email:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5><a href="{{'mailto:'.$driver->user->email}}">{{$driver->user->email}}</a></h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Phone:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5><a href="{{'tel:'.$driver->user->phone}}">{{$driver->user->phone}}</a></h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Private Hire License:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5>{{$driver->private_hire_license}}</h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Vehicle Registration:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5>{{$driver->vehicle_reg}}</h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Vehicle Make:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                                        <h5>{{$driver->vehicle_make}}</h5>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <h5  class="col-xl-4 col-sm-5 col-sm-4 ">Vehicle License:</h5>
                                    <div class="col-xl-8 col-lg-7 col-sm-8 mt-2">
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                @foreach($driver->trips as $trip)
                                    <tr>
                                        ...
                                        <td>{{date('d-m-Y', strtotime($trip->journey_date))}}</td>
                                        <td>{{$trip->collectable_by_driver}}</a></td>
                                        <td>{{$trip->collection_by_driver}}</td>
                                        <td class="text-center">
                                            @if($trip->trip_status == 0)
                                                <span class="badge badge-success">{{__('Trip is On '.$trip->jourmey_date.'') }}</span>
                                            @else
