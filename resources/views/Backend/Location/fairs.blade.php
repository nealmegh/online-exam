...
@section('head-customization')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset("css/theme/plugins/table/datatable/custom_dt_miscellaneous.css")}}">
    <style>
        .create-button{
            position: relative;
            width: fit-content;
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col 12 button-holder" style="display: flex">
                        <div class="col-8">
                            <h3>Locations to Airports Fairs</h3>
                        </div>
                        <div class="create-button col-4">
                            <a href="{{route('location.create')}}" class="create-button-btn btn btn-success mb-6 mr-4 btn-lg"> Create</a>
                        </div>
                    </div>
                    <table id="individual-col-search" class="table table-hover non-hover" style="width:100%">
                            <thead>
                            <tr>
                                <th>Location</th>
                                <th>Airport</th>
                            ...
                            @foreach($locations as $location)
                                ...
                                <tr>
                                    ...
                                    <td>{{$airport->pivot->return_price}}</td>
...
{{--    <script src="{{asset("js/theme/plugins/table/datatable/button-ext/buttons.print.min.js")}}"></script>--}}
    <script src="{{asset("js/theme/plugins/table/datatable/custom_miscellaneous.js")}}"></script>
