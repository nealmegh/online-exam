                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2><small>create</small> Location </h2>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form class="" novalidate method="POST" action="{{ route('location.store') }}">
                                @csrf
                                <div class="form-row mb-4">
                                    <label class="control-label" for="name">Name <span class="required">*</span>
                                    </label>
                                    <input id="name" class="form-control" name="name" placeholder="Name of the location" required="required" type="text">

                                </div>
                                <div class="form-row mb-4">
                                    <label class="control-label" for="display_name">Display Name <span class="required">*</span>
                                    </label>
                                    <input type="text" id="display_name" name="display_name" placeholder="Display Name of the location" required="required" class="form-control">
                                ...
                                @foreach($airports as $airport)
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-row">
                                        <input id="{{'price'.$airport->id}}" class="form-control col-md-5 mr-1" name="{{'price'.$airport->id}}" placeholder="Price" required="required" type="text">
                                        <input id="{{'return_price'.$airport->id}}" class="form-control col-md-5 ml-1"  name="{{'return_price'.$airport->id}}" placeholder="Return Price" required="required" type="text">
                                        </div>
                                    </div>
                                @endforeach
