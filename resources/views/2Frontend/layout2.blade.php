...
{{--                    <p class="center pricing-tag ls">From £62 0ne way</p>--}}
...
{{--                    <p class="center pricing-tag ls">From £112 One way</p>--}}
{{--                    <div class="price-list-bottom">--}}
{{--                        <p class="center ls">Book online or by phone</p>--}}
{{--                        <p class="center ls">24 hours drop off service</p>--}}
{{--                        <p class="center ls">Meet & Greet available</p>--}}
...
{{--            <div class="col-md-4 col-sm-4 price-fixed price-res-bottom">--}}
{{--                <div class="packages-bg">--}}
{{--                    <h4 class="center">London Luton Airport</h4>--}}
{{--                    <p class="center pricing-tag ls">From £70 One way</p>--}}
{{--                    <div class="price-list-bottom">--}}
{{--                        <p class="center ls">Book online or by phone</p>--}}
{{--                        <p class="center ls">24 hours drop off service</p>--}}
{{--                        <p class="center ls">Meet & Greet available</p>--}}
...
{{--                    <h4 class="center plans-fs distab-cell-middle plans-br plans-pad"><a href="#">London Heathrow</a>--}}
{{--                    </h4>--}}

{{--                    <p class="center plans-fs plans-price-fs ls distab-cell-middle plans-pad">£112 </p>--}}
{{--                </div>--}}

{{--                <!--=============== ROW-2 ==================-->--}}
{{--                <div class="distab plans-bg-1">--}}
{{--                    <h4 class="center plans-fs distab-cell-middle plans-br plans-pad"><a href="#">Stansted</a>--}}
{{--                    </h4>--}}

{{--                    <p class="center plans-fs plans-price-fs ls distab-cell-middle plans-pad">£62 </p>--}}
{{--                </div>--}}

{{--                <!--=============== ROW-3 ==================-->--}}
{{--                <div class="distab plans-bg-2">--}}
{{--                    <h4 class="center plans-fs distab-cell-middle plans-br plans-pad"><a href="#">Gatwick</a>--}}
{{--                    </h4>--}}

{{--                    <p class="center plans-fs plans-price-fs ls distab-cell-middle plans-pad">£133 </p>--}}
{{--                </div>--}}
{{--                <!--=============== ROW-3.1 ==================-->--}}
{{--                <div class="distab plans-bg-1">--}}
{{--                    <h4 class=" center plans-fs distab-cell-middle plans-br plans-pad"><a href="#">London City Airport</a>--}}
{{--                    </h4>--}}

{{--                    <p class="center plans-fs plans-price-fs ls distab-cell-middle plans-pad">£92 </p>--}}
{{--                </div>--}}

{{--                <!--=============== ROW-3.2 ==================-->--}}
{{--                <div class="distab plans-bg-2">--}}
{{--                    <h4 class="center plans-fs distab-cell-middle plans-br plans-pad"><a href="#">Luton</a>--}}
{{--                    </h4>--}}
...
<!--================================= FOOTER START =============================================-->
{{--@include('2Frontend.Associate.footer2')--}}
<!--================================= FOOTER END =============================================-->
